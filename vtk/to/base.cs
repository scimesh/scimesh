...
namespace Scimesh.Vtk.To
{
	public static class Base
	{
		...
		public static Dictionary<int, int[]> cellTypeToTrianglesMap;
		...
		public static Scimesh.Base.Mesh UnstructuredGridToMesh (string filename)
		{
...
//							UnityEngine.Debug.Log ("Reading CELL_TYPES " + tokens [1]);
		...
		public static Scimesh.Base.Mesh UnstructuredGridToMeshResources (string filename)
		{
			int[] intData = new int[0];
			float[] floatData = new float[0];
			Scimesh.Base.Point[] points = new Scimesh.Base.Point[0];
...
//						UnityEngine.Debug.Log ("Reading CELL_TYPES " + tokens [1]);
		...
		public static List<Scimesh.Base.PointField> VtkUnstructuredGridToPointFields (string filename)
		{
		...
		public static List<Scimesh.Base.CellField> VtkUnstructuredGridToCellFields (string filename)
		{
			List<List<float?>> fieldsData = new List<List<float?>> ();
			List<float?> fieldData = new List<float?> ();
			List<int> fieldsNComponents = new List<int> ();
